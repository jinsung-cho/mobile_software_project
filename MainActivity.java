...
//        relativeLayout.bringChildToFront(R.id.toolbarHeader);
            ...
            public boolean onPressEvent(ArrayList<TMapMarkerItem> arrayList, ArrayList<TMapPOIItem> arrayList1, TMapPoint tMapPoint, PointF pointF) {
                ...
                if (array[0].equals("1")) {
                    if (array[1].equals("본관")) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), Domitory.class);
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                if (childList.get(headerList.get(groupPosition)) != null) {
                    ...
                    if (model.getMenuName().equals("본관")) {
                        ...
                        intent.putExtra("name", "인문관");
                        startActivity(intent);
                    } else if (model.getMenuName().equals("기숙사")) {
                        Intent intent = new Intent(getApplicationContext(), Domitory.class);
                        intent.putExtra("name", "기숙사");
                        startActivity(intent);
                        ...
                        intent.putExtra("name", "학생회관");
                        startActivity(intent);
                    } else if (model.getMenuName().equals("중앙도서관")) {
                        Intent intent = new Intent(getApplicationContext(), library.class);
                        intent.putExtra("name", "중앙도서관");
                        startActivity(intent);
